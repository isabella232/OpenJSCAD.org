...
OpenJsCad.Viewer.ThreeEngine = function (containerEl, options) {
...
OpenJsCad.Viewer.ThreeEngine.prototype = {
  ...
  createControls: function() {
    ...
    var controls = new THREE.OrbitControls(this.camera_, this.canvas);
  ...
  drawAxes: function(axLen) {
    var axes = this.options.axis;
    var size = (axes.size || this.options.plate.size)/2;
